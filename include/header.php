                ...
                <div class="row">
             		 <div class="col-sm-12 col-xs-12 col-md-12">
                    	 <ul class="breadcrumb pull-right" id="contents">
                        	...
                        	<li>
                        		<a href="Pdf/Citizencharter/citizencharter.pdf" target="new">Citizen Charter</a>
                        	</li> 
                           ...
                           <li>   
                           	<!--Zoom-in And Zoom-out Menus--> 		                           
								<input class="incfont" type='button' value='+' onclick='increaseFont()' />
								<input class="reset" type='button' value='R' onclick=resetFont() />	
								<input class="decfont" type='button' value='-' onclick='decreaseFont()' />													        				
                           </li>
                           <li>
                           	<!--Theme Color Change Menus-->
                           	<div id="colorchanger">
	                    		<a class="colorbox colorblue" title="Blue Theme"></a>
	                    		<a class="colorbox colorgreen" title="Green Theme"></a>
	                    		<a class="colorbox colororange"  title="Orange Theme"></a>
                			</div>                           	
                           </li>                            			
						</ul>
					 </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-left">
                    <ul class="nav navbar-nav">
                        <li class="active" id="contents"><a href="index.php">Home</a></li>
